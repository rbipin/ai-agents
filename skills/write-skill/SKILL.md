---
name: write-skill
description: Scaffolds new agent skills in repository. Use when creating a new skill, generating SKILL.md files, or setting up skill directory structures. Handles frontmatter generation, section templates, and validation guidance.
---

# Create Skill

This skill helps you scaffold new agent skills that conform to the Agent Skills specification and repository conventions.
...
applyTo: [optional list of agent types or plugins this skill applies to]
compatibility: [optional list of environment or tool requirements]
skills: [optional list of related skills or dependencies]
triggersOn: [optional list of conditions or events that should trigger this skill]
---
```
